            ...
            foreach ($posts as $post) {
                ...
                $event = (new Eluceo\iCal\Domain\Entity\Event())
                    ...
                    ->setOccurrence(new Eluceo\iCal\Domain\ValueObject\TimeSpan(
                            new Eluceo\iCal\Domain\ValueObject\DateTime(DateTimeImmutable::createFromFormat('Y-m-d H:i:s', self::fdate($startdate)), true),
                            new Eluceo\iCal\Domain\ValueObject\DateTime(DateTimeImmutable::createFromFormat('Y-m-d H:i:s', self::fdate($enddate)), true),
                        )
                    )
